...
local Themes = {
    Dark = {
        ...
        AccentAlt   = Color3.fromRGB(110, 123, 255),
        Text        = Color3.fromRGB(255, 255, 255),
        TextSub     = Color3.fromRGB(148, 155, 164),
    ...
    Crimson = {
        ...
        Elevated    = Color3.fromRGB(36, 18, 18),
        Border      = Color3.fromRGB(60, 28, 28),
        Accent      = Color3.fromRGB(220, 50, 50),
        AccentAlt   = Color3.fromRGB(255, 80, 80),
    ...
    Emerald = {
        ...
        Card        = Color3.fromRGB(10, 22, 16),
        Elevated    = Color3.fromRGB(16, 34, 24),
        Border      = Color3.fromRGB(26, 56, 38),
        Accent      = Color3.fromRGB(52, 199, 120),
        AccentAlt   = Color3.fromRGB(80, 230, 150),
        Text        = Color3.fromRGB(240, 255, 245),
        TextSub     = Color3.fromRGB(140, 180, 155),
        TextMuted   = Color3.fromRGB(90, 130, 105),
        Green       = Color3.fromRGB(59, 200, 93),
        Red         = Color3.fromRGB(237, 66, 69),
    },
    Ocean = {
        Bg          = Color3.fromRGB(6, 12, 20),
        Card        = Color3.fromRGB(10, 20, 34),
        Elevated    = Color3.fromRGB(14, 30, 50),
        Border      = Color3.fromRGB(22, 50, 80),
        Accent      = Color3.fromRGB(30, 140, 220),
        AccentAlt   = Color3.fromRGB(60, 180, 255),
        Text        = Color3.fromRGB(220, 240, 255),
        TextSub     = Color3.fromRGB(120, 160, 200),
        TextMuted   = Color3.fromRGB(70, 110, 150),
        Green       = Color3.fromRGB(59, 165, 93),
        Red         = Color3.fromRGB(237, 66, 69),
    },
    Violet = {
        Bg          = Color3.fromRGB(10, 6, 18),
        Card        = Color3.fromRGB(16, 10, 28),
        Elevated    = Color3.fromRGB(26, 16, 44),
        Border      = Color3.fromRGB(44, 28, 72),
        Accent      = Color3.fromRGB(168, 85, 247),
        AccentAlt   = Color3.fromRGB(200, 120, 255),
        Text        = Color3.fromRGB(245, 235, 255),
        TextSub     = Color3.fromRGB(170, 140, 200),
        TextMuted   = Color3.fromRGB(110, 85, 145),
        Green       = Color3.fromRGB(59, 165, 93),
        Red         = Color3.fromRGB(237, 66, 69),
    },
    Rose = {
        Bg          = Color3.fromRGB(18, 8, 12),
        Card        = Color3.fromRGB(28, 12, 18),
        Elevated    = Color3.fromRGB(40, 18, 26),
        Border      = Color3.fromRGB(65, 28, 40),
        Accent      = Color3.fromRGB(240, 80, 130),
        AccentAlt   = Color3.fromRGB(255, 110, 160),
        Text        = Color3.fromRGB(255, 235, 242),
        TextSub     = Color3.fromRGB(200, 150, 170),
        TextMuted   = Color3.fromRGB(140, 95, 115),
        Green       = Color3.fromRGB(59, 165, 93),
        Red         = Color3.fromRGB(237, 66, 69),
    },
    Amber = {
        Bg          = Color3.fromRGB(16, 12, 4),
        Card        = Color3.fromRGB(26, 20, 6),
        Elevated    = Color3.fromRGB(38, 30, 8),
        Border      = Color3.fromRGB(62, 48, 12),
        Accent      = Color3.fromRGB(245, 175, 25),
        AccentAlt   = Color3.fromRGB(255, 205, 60),
        Text        = Color3.fromRGB(255, 248, 220),
        TextSub     = Color3.fromRGB(200, 175, 120),
        TextMuted   = Color3.fromRGB(140, 118, 72),
        Green       = Color3.fromRGB(59, 165, 93),
        Red         = Color3.fromRGB(237, 66, 69),
    },
    Ice = {
        Bg          = Color3.fromRGB(8, 14, 20),
        Card        = Color3.fromRGB(14, 22, 32),
        Elevated    = Color3.fromRGB(20, 32, 46),
        Border      = Color3.fromRGB(34, 54, 76),
        Accent      = Color3.fromRGB(120, 210, 240),
        AccentAlt   = Color3.fromRGB(160, 235, 255),
        Text        = Color3.fromRGB(220, 240, 255),
        TextSub     = Color3.fromRGB(130, 170, 200),
        TextMuted   = Color3.fromRGB(80, 115, 145),
        Green       = Color3.fromRGB(59, 165, 93),
        Red         = Color3.fromRGB(237, 66, 69),
    },
}
...
-- ─────────────────────────────────────────────────────────────
-- ACTIVE CONFIG (mutable, updated on theme switch)
-- ─────────────────────────────────────────────────────────────

local Config = {
    ToggleKey   = Enum.KeyCode.K,
    AnimSpeed   = 0.15,
    SaveFile    = "NexusData.json",
    Colors      = {},
    CurrentTheme = "Dark",
}
...
local function Gradient(parent, c1, c2, rotation)
    return Make("UIGradient", {
        Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0, c1 or Config.Colors.Accent),
            ColorSequenceKeypoint.new(1, c2 or Config.Colors.AccentAlt),
        }),
...
local function FlushThemed()
    for i = #ThemedObjects, 1, -1 do
        if not ThemedObjects[i].obj or not ThemedObjects[i].obj.Parent then
...
local function RecolorAll(speed)
    ...
    for _, entry in ipairs(ThemedObjects) do
        ...
        if color and entry.obj and entry.obj.Parent then
            Tween(entry.obj, {[entry.prop] = color}, speed, Enum.EasingStyle.Sine)
        end
    end
end
...
function Library.Init(cfg)
    ...
    if not self.Gui.Parent then
        pcall(function() self.Gui.Parent = Players.LocalPlayer:WaitForChild("PlayerGui") end)
    end
    ...
    -- Theme badge (shows current theme name)
    self._themeBadge = Make("TextLabel", {
        Size              = UDim2.new(0, 60, 0, 18),
        Position          = UDim2.new(1, -168, 0.5, -9),
        BackgroundColor3  = Config.Colors.Elevated,
        Text              = Config.CurrentTheme,
    ...
    local CloseLbl = Make("TextLabel", {
        ...
        BackgroundTransparency = 1,
        Text              = "×",
        TextColor3        = Config.Colors.TextSub,
        TextSize          = 18,
        Font              = Enum.Font.GothamBold,
        Parent            = CloseBtn,
    })
...
function Library:Toggle(state)
    ...
    if self.Open then
        ...
        if tw then tw.Completed:Connect(function() self.Main.Visible = false end) end
    end
end
...
function Library:SetTheme(name, speed)
    ...
    for _, cb in ipairs(self.ThemeCallbacks) do
        task.spawn(cb, name, Config.Colors)
    end
    if self.Data then
...
function Library:StartAutoTheme(intervalSeconds)
    ...
    for i, name in ipairs(ThemeOrder) do
        if name == Config.CurrentTheme then idx = i break end
    end
    ...
    self._autoThemeConn = RS.Heartbeat:Connect(function(dt)
        ...
        if self._autoThemeTimer >= self._autoThemeInterval then
            ...
            self:Notify({
                Title = "Theme Changed",
                Text  = "→ " .. ThemeOrder[self._autoThemeIdx],
                Time  = 2.5,
            })
        end
    end)
...
function Library:StopAutoTheme()
    ...
    if self._autoThemeConn then
        self._autoThemeConn:Disconnect()
        self._autoThemeConn = nil
    end
end
...
function Library:Notify(o)
    o = o or {}
    local accentColor = o.Type == "Success" and Config.Colors.Green
                     or o.Type == "Error"   and Config.Colors.Red
...
function Library:Tab(name)
    ...
    function Tab:Toggle(o)
        ...
        local Track = Make("Frame", {
            ...
            BackgroundColor3 = on and Config.Colors.Accent or Config.Colors.Bg,
            Parent           = C,
        })
        Round(Track, 9)
        ...
        Make("TextButton", {Size = UDim2.new(1, 0, 1, 0), BackgroundTransparency = 1, Text = "", Parent = C})
            .MouseButton1Click:Connect(function() on = not on Update() end)

        return {
            Set = function(_, v) on = v Update() end,
    ...
    function Tab:Slider(o)
        ...
        local Lbl = Make("TextLabel", {
            Size = UDim2.new(1, -42, 0, 18), Position = UDim2.new(0, 8, 0, 4),
            BackgroundTransparency = 1, Text = o.Name or "Slider",
            TextColor3 = Config.Colors.Text, TextSize = 11,
            Font = Enum.Font.GothamSemibold, TextXAlignment = Enum.TextXAlignment.Left, Parent = C,
        })
        TrackThemed(Lbl, "Text", "TextColor3")

        local ValLabel = Make("TextLabel", {
            Size = UDim2.new(0, 34, 0, 18), Position = UDim2.new(1, -42, 0, 4),
            BackgroundTransparency = 1, Text = tostring(val),
            TextColor3 = Config.Colors.Accent, TextSize = 11,
            Font = Enum.Font.GothamBold, TextXAlignment = Enum.TextXAlignment.Right, Parent = C,
        })
        TrackThemed(ValLabel, "Accent", "TextColor3")

        local Track = Make("Frame", {
            Size = UDim2.new(1, -16, 0, 4), Position = UDim2.new(0, 8, 0, 32),
            BackgroundColor3 = Config.Colors.Bg, Parent = C,
        })
        Round(Track, 2)
        ...
        local Fill = Make("Frame", {
            ...
            BackgroundColor3 = Config.Colors.Accent, Parent = Track,
        })
        Round(Fill, 2)
        ...
        local Knob = Make("Frame", {
            ...
            BackgroundColor3 = Config.Colors.Text, Parent = Track,
        })
        Round(Knob, 6)
        TrackThemed(Knob, "Text")
    ...
    function Tab:Keybind(o)
        ...
        local Lbl = Make("TextLabel", {
            Size = UDim2.new(1, -62, 1, 0), Position = UDim2.new(0, 8, 0, 0),
        ...
        local KeyBtn = Make("TextButton", {
            Size = UDim2.new(0, 52, 0, 20), Position = UDim2.new(1, -58, 0.5, -10),
            BackgroundColor3 = Config.Colors.Bg, Text = key.Name,
            TextColor3 = Config.Colors.Accent, TextSize = 10,
            Font = Enum.Font.GothamBold, Parent = C,
        })
        Round(KeyBtn, 4)
        ...
        UIS.InputBegan:Connect(function(i, g)
            ...
            elseif not g and i.KeyCode == key and o.OnPress then
    ...
    function Tab:Dropdown(o)
        ...
        Make("TextLabel", {
            Size = UDim2.new(0.38, 0, 0, 32), Position = UDim2.new(0, 8, 0, 0),
        ...
        local DropBtn = Make("TextButton", {
            Size = UDim2.new(0.58, -8, 0, 20), Position = UDim2.new(0.42, 0, 0, 6),
            BackgroundColor3 = Config.Colors.Bg, Text = selected .. " ▼",
            TextColor3 = Config.Colors.Accent, TextSize = 10,
            Font = Enum.Font.GothamSemibold, TextTruncate = Enum.TextTruncate.AtEnd, Parent = C,
        })
        Round(DropBtn, 4)
        TrackThemed(DropBtn, "Bg")
        TrackThemed(DropBtn, "Accent", "TextColor3")

        local OptionContainer = Make("Frame", {
            Size = UDim2.new(0.58, -8, 0, 0), Position = UDim2.new(0.42, 0, 0, 30),
            BackgroundColor3 = Config.Colors.Bg, ClipsDescendants = true, Visible = false, Parent = C,
        })
        ...
        for _, opt in ipairs(o.Options or {}) do
            local OB = Make("TextButton", {
                Size = UDim2.new(1, 0, 0, 20), BackgroundColor3 = Config.Colors.Elevated,
                BackgroundTransparency = 1, Text = opt,
                TextColor3 = Config.Colors.TextSub, TextSize = 10,
                Font = Enum.Font.Gotham, Parent = OptionList,
            })
            Round(OB, 3)
        ...
        return {
            Set = function(_, v) selected = v DropBtn.Text = selected .. " ▼" end,
    ...
    function Tab:TextBox(o)
        ...
        local Lbl = Make("TextLabel", {
            Size = UDim2.new(0.32, 0, 1, 0), Position = UDim2.new(0, 8, 0, 0),
        ...
        local Box = Make("TextBox", {
            ...
            BackgroundColor3 = Config.Colors.Bg, Text = txt,
            PlaceholderText = o.Placeholder or "...",
            TextColor3 = Config.Colors.Text, PlaceholderColor3 = Config.Colors.TextMuted,
        ...
        return {
            Set = function(_, v) txt = v Box.Text = v end,
            Get = function() return txt end,
        }
    end
    ...
    function Tab:ColorDisplay(o)
        ...
        local Swatch = Make("Frame", {
            ...
            BackgroundColor3 = color, Parent = C,
        })
        Round(Swatch, 4)
        Stroke(Swatch, Config.Colors.Border, 1)

        return {
            Set = function(_, v) color = v Swatch.BackgroundColor3 = v if o.Callback then task.spawn(o.Callback, v) end end,
...
function Library:AddVisuals()
    ...
    T:Section("Lighting")
    T:Slider({Name = "Brightness", Min = 0, Max = 10, Default = math.floor(Lighting.Brightness),
        Callback = function(v) Lighting.Brightness = v end})
    T:Slider({Name = "Time of Day", Min = 0, Max = 24, Default = math.floor(Lighting.ClockTime),
    ...
    T:Toggle({Name = "No Fog", Default = false,
        Callback = function(v) Lighting.FogEnd = v and 1e9 or 1e5 end})

    T:Section("Shadows")
    T:Toggle({Name = "Global Shadows", Default = Lighting.GlobalShadows,
...
function Library:AddThemeTab()
    ...
    for _, themeName in ipairs(ThemeOrder) do
        T:Button({
            ...
            Callback = function()
                ...
                lib:Notify({Title = "Theme", Text = themeName .. " applied!", Time = 2})
            end,
        })
    end
    ...
    local autoToggle = T:Toggle({Name = "Auto Theme Cycle", Default = false, Callback = function(v)
        autoEnabled = v
        if v then
            lib:StartAutoTheme(lib._autoInterval or 30)
            lib:Notify({Title = "Auto Theme", Text = "Cycling every " .. (lib._autoInterval or 30) .. "s", Time = 2.5})
        else
            lib:StopAutoTheme()
        end
    end})
    ...
    T:Slider({Name = "Interval (seconds)", Min = 5, Max = 120, Default = 30, Callback = function(v)
        ...
        if autoEnabled then
            lib:StopAutoTheme()
            lib:StartAutoTheme(v)
        end
    end})

    T:Label("Current: " .. Config.CurrentTheme)
    lib:OnThemeChanged(function(name)
        -- label update handled internally
    end)
